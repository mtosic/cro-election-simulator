    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ElectionLists", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ElectionLists_Parties_PartyId",
                        column: x => x.PartyId,
                        principalTable: "Parties",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ElectionLists_PollingStations_PollingStationId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CandidateVote_Candidates_CandidateId",
                        column: x => x.CandidateId,
                        principalTable: "Candidates",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CandidateVote_ElectionLists_ElectionListId",
                        column: x => x.ElectionListId,
                        principalTable: "ElectionLists",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CandidateVote_CandidateId",
                table: "CandidateVote",
                column: "CandidateId");

            migrationBuilder.CreateIndex(
                name: "IX_CandidateVote_ElectionListId",
                table: "CandidateVote",
                column: "ElectionListId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ElectionLists_PollingStationId",
                table: "ElectionLists",
